...
import (
	...
	model1 "../../model1/driver_management_model"
	"../../response"
...
// func SearchStoreInformation(w http.ResponseWriter, r *http.Request) {
// 	var _response initialize.Response
// 	var Search []initialize.StoreInformationDriver
// 	json.NewDecoder(r.Body).Decode(&Search)
// 	db := db.Connect()
// 	_con := model1.Models_init{DB: db}
// 	ExcuteData, err := _con.SearchStoreInformationDriver(&Search)
// 	if err != nil {
// 		panic(err.Error())
// 	}
...
func ReturnAllStoreInformationPagination(w http.ResponseWriter, r *http.Request) {
	...
	var arrStoreInformation []initialize.StoreInformationDriver
	var _response initialize.Response
...
// 	var init_insert initialize.StoreInformationDriver
// 	var _response initialize.Response
