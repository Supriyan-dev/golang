...
func NewFloat(f float64, valid bool) NullFloat {
	return NullFloat{
...
func FloatFrom(f float64) NullFloat {
	return NewFloat(f, true)
}

// FloatFromPtr creates a new Float that be null if f is nil.
func FloatFromPtr(f *float64) NullFloat {
	if f == nil {
...
func (f NullFloat) ValueOrZero() float64 {
	if !f.Valid {
		return 0
	}
	return f.Float64
...
func (f NullFloat) Equal(other NullFloat) bool {
