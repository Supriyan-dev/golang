...
// NullDate is an alias for mysql.NullTime data type
...
func (nt *NullDate) MarshalJSON() ([]byte, error) {
	...
	val := fmt.Sprintf("\"%s\"", nt.Time.Format("02-01-2006"))
	return []byte(val), nil
}
...
func (nt *NullTime) MarshalJSON() ([]byte, error) {
	...
	val := fmt.Sprintf("\"%s\"", nt.Time.Format("15:04:05"))
	return []byte(val), nil
}
...
// NullDateTime is an alias for mysql.NullTime data type
